...
def main():
    time.sleep(2)
    while True:
        move(-521,1336) # Scroll Up to top of list
        count = 30
        while count > 0:
            singleclick()
            count -= 1
        ...
        move(-636,1364) # Click First Name
        singleclick()
        time.sleep(1)
        
        move(-248,1332) # Click Inactivate
        singleclick()
        time.sleep(1)
        
        move(-104,1519) # Confirm Incativation
        singleclick()
        time.sleep(1)
        
        move(-397,1331) # Click Save
        singleclick()
        #rightclick()
        time.sleep(2)
        print("Complete")
